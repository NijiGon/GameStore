<%@ Page Title="" Language="C#" MasterPageFile="~/View/Site.Master" AutoEventWireup="true" CodeBehind="ModifyGame.aspx.cs" Inherits="GameStore.View.UpdateGame" %>
            ...
            <div class="profile-info ms-5 w-100 py-5 me-5">
                <div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <asp:TextBox type="" class="form-control bg-grayeesh border-2 gray-placeholder text-primary text-white" placeholder="" ReadOnly="true" aria-label="Username" aria-describedby="basic-addon1" ID="tbPrice" runat="server"></asp:TextBox>
                    </div>
                    <div class="input-group mb-3 d-flex flex-column">
